    ...
    bool isValidSudoku(vector<vector<char>>& board) {
        ...
        for (int i = 0; i < 9; ++i) {
            for (int j = 0; j < 9; ++j) {
                ...
                else if (htable[board[i][j]] == 1) return false;
                else htable[board[i][j]]++;
            }
            htable.clear();
        }
        ...
        for (int i = 0; i < 9; ++i) {
            for (int j = 0; j < 9; ++j) {
                ...
                else if (htable[board[j][i]] == 1) return false;
                else htable[board[j][i]]++;
            }
            htable.clear();
        }
        ...
        while (1) {
            char ch = board[i][j];
            if (ch != '.' && htable[ch] == 1) return false;
            else if (ch != '.') htable[ch]++;
